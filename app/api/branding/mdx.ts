export const BrandIdentityGlobal = `      
      <div className="">
        <div className="relative sm:flex gap-6 items-center p-4 lg:p-10 max-w-6xl mx-auto mt-12 lg:mt-20 min-h-screen">
          <div className="flex-1 sm:sticky sm:top-15 h-[calc(100vh-12rem)] ">
            <div className="sm:relative sm:top-0 w-full h-full rounded-2xl overflow-hidden ">
              <Image
              width={400}
              height={400}
                src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/global//man.png"
                alt="Brand Identity Visual"
                className="w-full object-contain"
              />
            </div>
          </div>
          <div className="flex-1 z-10 pt-6 sm:pt-0">
            <h1 className="text-xl lg:text-5xl font-extrabold mb-4 lg:mb-8 leading-tight text-[#01acec]">
              Brand Identity
            </h1>
            <p className="text-sm lg:text-lg leading-6 text-neutral-700 dark:text-neutral-300">
              ...
              global unity. The brand book serves as a comprehensive guide to
              maintaining the integrity and consistency of our brand across all
              platforms and communications.
            </p>
          </div>
        </div>

        <div className="relative sm:flex gap-6 items-center p-4 lg:p-10 max-w-6xl mx-auto mt-16 lg:mt-24 min-h-screen">
          <div className="flex-1 z-10 pt-6 sm:pt-0 order-2 sm:order-1">
            <h1 className="text-xl lg:text-5xl font-extrabold mb-4 lg:mb-8 leading-tight text-[#01acec]">
              Our Mission
            </h1>
            <p className="text-sm lg:text-lg leading-6 text-neutral-700 dark:text-neutral-300 mb-2">
          ...
          <div className="flex-1 sticky top-15 h-[calc(100vh-12rem)] order-1 sm:order-2 mb-8 sm:mb-0">
            <div className="relative w-full h-full rounded-2xl overflow-hidden ">
              <Image
              width={400}
              height={400}
                src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/global//person.png"
        ...
        <div className="relative sm:flex gap-6 items-start p-4 lg:p-10 max-w-6xl mx-auto mt-16 lg:mt-24">
          <div className="flex-1 sticky top-15 h-[calc(100vh-12rem)] hidden sm:block">
            <div className="relative w-full h-full rounded-2xl overflow-hidden ">
              <Image
              width={400}
              height={400}
                src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/global//hand.png"
          ...
          <div className="flex-1 z-10 pt-6 sm:pt-0">
            ...
            <p className="text-sm lg:text-lg leading-6 text-neutral-700 dark:text-neutral-300">
              ...
              athletes from around the globe to showcase their talents and push
              the boundaries of what is possible with robotics.
            </p>
          </div>
        </div>
      </div>
...
export const BrandIdentityCA = `<div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 justify-between min-h-[300px] text-sm p-0">
...
export const item2 = `FIRA Iran's brand personality is defined based on the Magician archetype—the kind of magician that brings the future into the present and creates transformative experiences for its audience.
...
export const item2CA = `FIRA Canada's brand personality is defined based on the Magician archetype—the kind of magician that brings the future into the present and creates transformative experiences for its audience.
...
<div className="w-full px-6 sm:px-12 lg:px-24 rounded-2xl">
  <div className="grid lg:grid-cols-2 gap-10 text-sm text-neutral-700 dark:text-neutral-300">
    <div className="flex gap-4">
      <div className="flex-shrink-0 p-3 bg-[#01acec] opacity-50 rounded-full">
...
export const MascotG = `<div className="space-y-24">
  {/* Section 1 */}
  <section className="flex flex-col lg:flex-row items-center gap-6">
    <img
      src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/global//mascot.png"
      alt="FIRA Mascot"
    ...
    <div className="p-6 text-sm text-neutral-700 dark:text-neutral-300 leading-6">
      ...
      <p className="mb-4">
        As part of the FIRA (Federation of International Robot-soccer Association)
        brand identity, each participating country is required to design and define a
        unique mascot or character that reflects the cultural symbols and heritage
        of their nation.
      </p>
      <p className="mb-4">
        <span className=" font-semibold">Purpose and Significance</span>
        <br />
        The mascot serves not only as a symbol of the participating country but also
        as an ambassador that embodies the spirit, values, and identity of the nation.
        It enhances visibility, recognition, and excitement during FIRA events.
      </p>
      <p>
        <span className=" font-semibold">Design Criteria:</span>
        <br />• <span className="font-medium">Cultural Relevance:</span> Should include recognizable elements from the country’s culture.
        <br />• <span className="font-medium">Uniqueness:</span> A distinct character not easily confused with others.
      </p>
    </div>
  </section>

  {/* Section 2 */}
  <section className="flex flex-col lg:flex-row-reverse items-center gap-6">
    <img
      src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/global//mascot1.png"
    ...
    <div className="p-6 text-sm text-neutral-700 dark:text-neutral-300 leading-6">
      ...
      <p className="mb-4">
        <span className="font-medium">Engagement:</span> The design should connect with both
        local and global audiences.
        <br />
        <span className="font-medium">Versatility:</span> Adaptable across print, digital, and
        physical formats.
      </p>
      <p className="mb-4">
        <span className=" font-semibold">Usage:</span>
        <br />• <span className="font-medium">Event Participation:</span> Showcased during ceremonies and competitions.
        <br />• <span className="font-medium">Marketing:</span> Used in merchandise and campaigns.
        <br />• <span className="font-medium">Official Communications:</span> Appears in newsletters and social media.
      </p>
      <p>
        <span className="font-medium">Implementation:</span> Countries are encouraged to
        involve creative communities to ensure the mascot becomes a source
        of national pride and cultural expression.
      </p>
    </div>
  </section>
</div>
...
export const DesignPrinciplesCA = ` <div className="mt-20 px-4 sm:px-8 lg:px-16">
...
<div className="max-w-screen-xl mx-auto columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(10).png" alt="Gallery Image 1" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(11).png" alt="Gallery Image 2" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(12).png" alt="Gallery Image 3" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(13).png" alt="Gallery Image 4" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(2).png" alt="Gallery Image 5" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(3).png" alt="Gallery Image 6" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(4).png" alt="Gallery Image 7" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(5).png" alt="Gallery Image 8" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(6).png" alt="Gallery Image 9" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(7).png" alt="Gallery Image 10" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(8).png" alt="Gallery Image 11" />
    <img className="w-full h-auto rounded" src="https://kbgnpdzggogidjwifiuq.supabase.co/storage/v1/object/public/harchi/identity-in-use/Copy%20of%20FIRA%20Brand%20Book%20(9).png" alt="Gallery Image 12" />
  </div>
`;
...
export const MDXComponentCa = `<div className=" px-6 py-12 space-y-12">
        <section>
